...
Solution
	...
	There¡¯s one problem with that solution though: we will ¡°recognize¡± those 0s later on in our iteration and then set their row and column to zero 
	...
	No Since we¡¯re going to set the entire row and column to zero, do we really need to track which cell in a row is zero? 
